...
background = pygame.image.load("/Users/shinjeongsub/Desktop/Python Workspace/Pygame/img/ddong_img/background.jpg")

character = pygame.image.load("/Users/shinjeongsub/Desktop/Python Workspace/Pygame/img/ddong_img/character.png")
...
# 똥1
poo = pygame.image.load("/Users/shinjeongsub/Desktop/Python Workspace/Pygame/img/ddong_img/poo.png")
...
start_menu = game_font.render("Press any key", True, (0,0,0))
screen.blit(start_menu,(100,500))
...
board1_rect = board1.get_rect(center=(int(screen_width/2), int(screen_height/2)-100))
board2_rect = board2.get_rect(center=(int(screen_width/2), int(screen_height/2)-70))
board3_rect = board3.get_rect(center=(int(screen_width/2), int(screen_height/2)-40))

screen.blit(board1,(board1_rect))
